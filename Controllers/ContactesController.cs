...
namespace FAIS_PROTOTIPO_.Controllers
{
    public class ContactesController : Controller
    {
        ...
        public ContactesController(FaisContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Email,Asunto,Telefono,Mensaje")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Email,Asunto,Telefono,Mensaje")] Contacto contacto)
        {
            if (id != contacto.Id)
            {
                return NotFound();
